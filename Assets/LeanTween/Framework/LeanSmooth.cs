...
* fromColor = LeanSmooth.damp(fromColor, dude5Title.GetComponent<Renderer>().material.colorSo, ref velocityColor, 1.1f);<br />
* Debug.Log("Smoothed y:" + fromY + " vec3:" + fromVec3 + " colorSo:" + fromColor);<br />
*
* @class LeanSmooth
*/
...
public class LeanSmooth {
    ...
    */
    ...
    /**
    * <summary>Moves one colorSo value towards another colorSo (eases in and out to destination with no overshoot)</summary>
    * 
    ...
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @example
    * fromColor = LeanSmooth.damp(fromColor, transform.GetComponent<Renderer>().material.colorSo, ref velocityColor, 1.1f);\n
    ...
    */
    ...
    /**
    * <summary>Moves one colorSo towards another (eases in and out to destination with possible overshoot bounciness)</summary>
    * 
    ...
    * @param {float} [accelRate]:float the rate it accelerates from it's initial position
    * @example
    * fromColor = LeanSmooth.spring(fromColor, transform.GetComponent<Renderer>().material.colorSo, ref velocityColor, 1.1f);\n
    * Debug.Log("current:"+fromColor);
    */
    ...
    */
    ...
    /**
    * <summary>Moves one colorSo towards another (at a constant speed)</summary>
    * 
    ...
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @example
    * fromColor = LeanSmooth.linear(fromColor, transform.GetComponent<Renderer>().material.colorSo, 50f);\n
    * Debug.Log("current:"+fromColor);
    */
    ...
    */
    ...
    /**
    * <summary>Moves one colorSo towards another (with an ease that bounces back some when it reaches it's destination)</summary>
    * 
    ...
    * @param {float} [hitDamping]:float the rate at which to dampen the bounciness of when it reaches it's destination
    * @example
    * fromColor = LeanSmooth.bounceOut(fromColor, transform.GetComponent<Renderer>().material.colorSo, ref followVelocity, 1.1f);\n
    * Debug.Log("current:" + fromColor);
    */
